...
![Home page mobile Wireframe](assets/images/wireframe/wireframe1.gif)

### Home page tablet and PC Wireframe
![Home page tablet and PC Wireframe](assets/images/wireframe/wireframe2.gif)
...
I chose "Poiret One" from Google font's web site. It has a strong charactor but feeling not pointy.
---------------------------------------------------
